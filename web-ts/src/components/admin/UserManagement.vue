        ...
        <div class="d-flex align-start">
          ...
          <div class="flex-grow-1">
            <div class="d-flex align-center justify-space-between mb-2">
              <div class="d-flex align-center">
                ...
                <v-chip
                  ...
                  size="x-small"
                >
                  <v-icon icon="mdi-check-circle" size="12" class="mr-1" color="green-darken-2"></v-icon>
                ...
                <v-chip
                  ...
                  size="x-small"
                >
                  <v-icon icon="mdi-block-helper" size="12" class="mr-1" color="red-darken-2"></v-icon>
            ...
            <div class="bg-grey-lighten-5 rounded-lg pa-3 mb-3">
              <div class="d-flex align-center mb-2">
                ...
                <v-chip
                  ...
                  class="ml-2"
                >
                  <v-icon icon="mdi-alert-circle" size="12" class="mr-1" color="orange-darken-2"></v-icon>
            ...
            <div class="d-flex align-center mt-3 ga-2">
              ...
              >
                <v-icon icon="mdi-block-helper" size="16" class="mr-1" color="red-darken-2"></v-icon>
              ...
              >
                <v-icon icon="mdi-check-circle" size="16" class="mr-1" color="green-darken-2"></v-icon>
