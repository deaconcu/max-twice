...
public enum ErrorCode {
    ...
    USER_VERIFICATION_CODE_INVALID(1108, "验证码无效"),
    USER_VERIFICATION_CODE_NOT_FOUND(1109, "验证码不存在"),
    USER_VERIFICATION_CODE_EXPIRED(1110, "验证码已过期"),
    USER_ALREADY_FOLLOWED(1111, "已关注该用户"),
    USER_SUBSCRIPTION_PARSE_ERROR(1112, "订阅数据解析失败"),
