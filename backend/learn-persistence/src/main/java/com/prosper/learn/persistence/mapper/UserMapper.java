...
public interface UserMapper {
    ...
    @Insert("INSERT INTO user(name, password, phone, email, email_validated, biography, created_at, updated_at) " +
            "VALUES (#{name}, #{password}, #{phone}, #{email}, #{emailValidated}, #{biography}, #{createdAt}, #{updatedAt})")
