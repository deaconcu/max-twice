...
GET    /api/v1/comments                   # 获取评论列表
       ?objectId=123&contentType=post&page=0&size=20
...
POST   /api/v1/upvotes                    # 点赞/取消点赞
       body: {"objectId": 123, "contentType": "post", "type": "once"}
GET    /api/v1/upvotes/status             # 获取点赞状态
       ?objectId=123&contentType=post
...
POST   /api/v1/aggregates/upvote          # 点赞操作
       body: {"objectId": 123, "contentType": 1, "type": 2}
