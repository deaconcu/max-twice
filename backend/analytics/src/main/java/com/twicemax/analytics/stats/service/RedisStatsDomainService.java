...
import com.twicemax.shared.common.constants.RedisStatsConstants;
...
public class RedisStatsDomainService {
     ...
     */
    public Map<Long, DailyStatsDTO> batchGetTodayStatsForContent(
     ...
     * 从 Redis 解析用户当日统计数据
     */
    private UserDailyStatsDTO parseUserDailyStatsFromRedis(
