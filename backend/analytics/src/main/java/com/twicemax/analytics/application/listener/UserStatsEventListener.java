...
import com.twicemax.shared.domain.event.content.lifecycle.ContentDeletedEvent;
...
import com.twicemax.shared.domain.event.user.relationship.UserFollowedEvent;
import com.twicemax.shared.domain.event.user.relationship.UserUnfollowedEvent;
import com.twicemax.shared.domain.event.user.review.CardReviewedEvent;
