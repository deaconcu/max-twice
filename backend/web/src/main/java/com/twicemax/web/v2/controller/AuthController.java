...
public class AuthController {
    ...
    public UserProfileDTO verifyLoginCode(
    ...
    @RateLimit(capacity = 5, refillPeriod = 1, refillUnit = TimeUnit.MINUTES, limitType = LimitType.IP)
    public PendingSessionDTO resendLoginCode(
            @RequestBody @Valid ResendVerificationCodeRequest request) {
        return authService.resendLoginCode(request.getPendingSessionToken());
    }
