    ...
    <v-row class="mt-2">
      ...
      <v-col cols="12" lg="3" class="d-none d-lg-block">
        <div class="sticky-sidebar">
          <!-- 学习统计 -->
          <v-card flat color="grey-lighten-5" rounded="lg" class="mb-4 flat-card">
            <v-card-text class="pa-6">
              <div class="d-flex align-center mb-4">
                <v-avatar color="grey-darken-2" size="32" class="mr-3 flat-avatar">
                  <v-icon icon="mdi-chart-donut" color="white" size="18"></v-icon>
                </v-avatar>
                <div>
                  <h3 class="text-h6 font-weight-bold text-grey-darken-4">学习统计</h3>
                  <p class="text-body-2 text-grey-darken-2 mb-0">跟踪你的学习进展</p>
                </div>
              </div>
              ...
              <div class="text-center mb-4">
                <v-progress-circular
                  ...
                  <div class="text-center">
                    <div class="text-h5 font-weight-bold text-primary">75%</div>
                    <div class="text-caption text-grey-darken-1">总进度</div>
                  </div>
                </v-progress-circular>
              </div>
              ...
              <div class="d-flex justify-space-between mb-4">
                <div class="text-center stat-item">
                  <v-chip color="grey-darken-2" variant="flat" size="small" class="mb-2 flat-chip">
                    <span class="text-white font-weight-bold">15</span>
                  </v-chip>
                  <div class="text-caption text-grey-darken-2">已完成</div>
                </div>
                <div class="text-center stat-item">
                  <v-chip color="primary" variant="flat" size="small" class="mb-2 flat-chip">
                    <span class="text-white font-weight-bold">3</span>
                  </v-chip>
                  <div class="text-caption text-grey-darken-2">进行中</div>
                </div>
                <div class="text-center stat-item">
                  <v-chip color="grey-lighten-3" variant="flat" size="small" class="mb-2 flat-chip">
                    <span class="text-grey-darken-3 font-weight-bold">2</span>
                  </v-chip>
                  <div class="text-caption text-grey-darken-2">待开始</div>
                </div>
              </div>
              ...
              <div class="d-flex align-center justify-space-between">
                <div class="d-flex align-center">
                  <v-icon icon="mdi-clock-outline" color="primary" size="16" class="mr-2"></v-icon>
                  <span class="text-body-2 text-grey-darken-2">本周学习</span>
                </div>
                <v-chip color="primary" variant="flat" size="small" class="flat-chip">
                  <span class="text-white font-weight-bold">12.5小时</span>
                </v-chip>
              </div>
            </v-card-text>
          </v-card>
          ...
          <v-card flat color="grey-lighten-5" rounded="lg" class="mb-4 flat-card">
            <v-card-text class="pa-6">
              <div class="d-flex align-center mb-4">
                <v-avatar color="grey-darken-2" size="32" class="mr-3 flat-avatar">
                  <v-icon icon="mdi-fire" color="white" size="18"></v-icon>
                </v-avatar>
                <div>
                  <h3 class="text-h6 font-weight-bold text-grey-darken-4">热门推荐</h3>
                  <p class="text-body-2 text-grey-darken-2 mb-0">社区最受欢迎的学习路径</p>
                </div>
              </div>

              <div class="space-y-3">
                <div v-for="(roadmap, index) in roadmaps.slice(0, 3)" :key="roadmap.id" 
                     class="flat-sidebar-item" 
                     @click="openModal(roadmap)">
                  <div class="d-flex align-start">
                    <div class="">
                      <div class="text-body-2 font-weight-bold text-grey-darken-4 mb-1">
                        {{ roadmap.description || '课程表 ' + roadmap.id }}
                      </div>
                      <div class="d-flex align-center">
                        <v-icon icon="mdi-heart-outline" color="grey-darken-1" size="12" class="mr-1"></v-icon>
                        <span class="text-caption text-grey-darken-2">{{ roadmap.vote || 0 }} 点赞</span>
                        <v-chip size="x-small" color="primary" variant="flat" class="ml-2 flat-chip">
                          <v-icon icon="mdi-trending-up" size="10" class="mr-1" color="white"></v-icon>
                          <span class="text-white">热门</span>
                        </v-chip>
                      </div>
                    </div>
                  </div>
          ...
          <!-- 学习建议 -->
          <v-card flat color="grey-lighten-5" rounded="lg" class="flat-card">
            <v-card-text class="pa-6">
              <div class="d-flex align-center mb-4">
                <v-avatar color="grey-darken-2" size="32" class="mr-3 flat-avatar">
                  <v-icon icon="mdi-lightbulb-outline" color="white" size="18"></v-icon>
                </v-avatar>
                <div>
                  <h3 class="text-h6 font-weight-bold text-grey-darken-4">学习建议</h3>
                  <p class="text-body-2 text-grey-darken-2 mb-0">专业导师的学习指导</p>
                </div>
              </div>

              <div class="mb-4">
                <p class="text-body-2 text-grey-darken-2 mb-0">
                  制定合理的学习计划，循序渐进地掌握Java编程技能，保持持续学习的习惯。
                </p>
              </div>

              <div class="space-y-3">
                <div class="flat-learning-tip">
                  <div class="d-flex align-start">
                    <v-chip color="primary" variant="flat" size="small" class="px-1 mr-3 flat-chip number-chip">
                      <v-icon icon="mdi-numeric-1" color="white" size="18"></v-icon>
                    </v-chip>
                    <div>
                      <div class="text-body-2 font-weight-medium text-grey-darken-4">基础先行</div>
                      <div class="text-caption text-grey-darken-2">扎实掌握Java基础语法和概念</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="flat-learning-tip">
                  <div class="d-flex align-start">
                    <v-chip color="grey-darken-2" variant="flat" size="small" class="px-1 mr-3 flat-chip number-chip">
                      <v-icon icon="mdi-numeric-2" color="white" size="18"></v-icon>
                    </v-chip>
                    <div>
                      <div class="text-body-2 font-weight-medium text-grey-darken-4">实践结合</div>
                      <div class="text-caption text-grey-darken-2">理论学习与实际项目相结合</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="flat-learning-tip">
                  <div class="d-flex align-start">
                    <v-chip color="grey-darken-2" variant="flat" size="small" class="px-1 mr-3 flat-chip number-chip">
                      <v-icon icon="mdi-numeric-3" color="white" size="18"></v-icon>
                    </v-chip>
                    <div>
                      <div class="text-body-2 font-weight-medium text-grey-darken-4">持续更新</div>
                      <div class="text-caption text-grey-darken-2">跟上技术发展趋势和新特性</div>
                    </div>
                  </div>
                </div>
              </div>
