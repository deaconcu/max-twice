    ...
    <div class="d-flex flex-row pt-4">
      ...
      <div class="sidebar-container" style="min-width:260px;">
        ...
        <v-tabs v-model="tab" color="teal" direction="vertical" class="px-2" flat>
          <v-tab prepend-icon="mdi-cog-outline" :text="t('admin.systemConfig')" value="system-config"
          ...
          <v-tab prepend-icon="mdi-briefcase-check-outline" :text="t('admin.professionManagement')" value="profession-management"
            class="text-body-1 text-grey-darken-2 my-1 rounded-lg justify-start"></v-tab>
          <v-tab prepend-icon="mdi-email-outline" :text="t('admin.courseManagement')" value="course-management"
            class="text-body-1 text-grey-darken-2 my-1 rounded-lg justify-start"></v-tab>
          ...
          <v-tab prepend-icon="mdi-note-check-outline" :text="t('admin.reviewArticles')" value="post-review"
            class="text-body-1 text-grey-darken-2 my-1 rounded-lg justify-start"></v-tab>
          <v-tab prepend-icon="mdi-comment-check-outline" :text="t('admin.reviewComments')" value="comment-review"
            class="text-body-1 text-grey-darken-2 my-1 rounded-lg justify-start"></v-tab>
        </v-tabs>
      </div>
      ...
      <div class="flex-grow-1 px-4 pl-6">
        <!-- 系统配置 -->
        <v-card v-if="tab == 'system-config'" flat class="pa-6" rounded="lg">
          <SystemConfiguration />
        </v-card>
        ...
        <!-- 职业申请管理 -->
        <v-card v-if="tab == 'profession-management'" flat class="pa-6" rounded="lg">
        ...
        <!-- 文章审核 -->
        <v-card v-if="tab == 'post-review'" flat class="pa-6" rounded="lg">
          <PostReview />
        </v-card>
