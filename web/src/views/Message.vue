          ...
          <v-card flat color="grey-lighten-5" rounded="lg" class="mb-4">
            <v-card-text class="pa-4">
              <div class="d-flex align-center mb-3">
                ...
                <div>
                  <h3 class="text-h6 font-weight-bold text-grey-darken-4">消息统计</h3>
                  <p class="text-body-2 text-grey-darken-2 mb-0">您的消息数据概览</p>
                </div>
              </div>

              <div class="d-flex justify-space-between align-center mb-2">
                <span class="text-body-2 text-grey-darken-3">今日新消息</span>
                <span class="text-h6 font-weight-bold text-primary">{{ todayMessages || 3 }}</span>
              </div>
              <div class="d-flex justify-space-between align-center mb-2">
                <span class="text-body-2 text-grey-darken-3">本周消息</span>
                <span class="text-h6 font-weight-bold text-primary">{{ weekMessages || 15 }}</span>
              </div>
              <div class="d-flex justify-space-between align-center mb-2">
                <span class="text-body-2 text-grey-darken-3">未读消息</span>
                <span class="text-h6 font-weight-bold text-error">{{ unreadMessages || 2 }}</span>
              </div>
              <div class="d-flex justify-space-between align-center">
                <span class="text-body-2 text-grey-darken-3">回复率</span>
                <span class="text-h6 font-weight-bold text-success">85%</span>
              </div>
            </v-card-text>

            <v-card-actions class="px-4 pb-4">
              <v-btn variant="flat" color="grey-darken-2" rounded="lg" density="comfortable" class="w-100">
                <v-icon icon="mdi-message-settings" class="mr-2" size="16"></v-icon>
                消息设置
              </v-btn>
            </v-card-actions>
          </v-card>
            ...
            <v-card-text class="pa-4">
              ...
              <div class="d-flex flex-column gap-2">
                <v-btn variant="tonal" color="primary" rounded="lg" density="default" class="justify-start mb-2">
                  <v-icon icon="mdi-check-all" class="mr-2" size="16"></v-icon>
                  标记全部已读
                </v-btn>
                <v-btn variant="tonal" color="info" rounded="lg" density="default" class="justify-start mb-2">
                  <v-icon icon="mdi-filter" class="mr-2" size="16"></v-icon>
                  筛选消息
                </v-btn>
          ...
          <v-card flat color="grey-lighten-5" rounded="lg">
            <v-card-text class="pa-4">
              <div class="d-flex align-center mb-3">
                ...
                <div>
                  <h3 class="text-h6 font-weight-bold text-grey-darken-4">相关课程</h3>
                  <p class="text-body-2 text-grey-darken-2 mb-0">推荐学习内容</p>
                </div>
              </div>
