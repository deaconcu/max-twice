...
// 本地状态
const selectedMainCategory = ref(props.modelMainCategory);
const selectedSubCategory = ref(props.modelSubCategory);
...
// 监听外部props变化
watch(() => props.modelMainCategory, (newValue) => {
  selectedMainCategory.value = newValue;
});

watch(() => props.modelSubCategory, (newValue) => {
