  ...
  <div class="w-100">
    ...
    <div class="w-100 d-flex justify-space-between align-end pb-2 pt-3">
      <div class="">
        ...
        <template v-if="posting.type == POST_TYPE.CONTENTS">
          <v-btn
            :variant="posting.voteType === VOTE_TYPE.HELPFUL ? 'text' : 'outlined'"
            rounded="lg"
            density="comfortable"
            :color="posting.voteType === VOTE_TYPE.HELPFUL ? 'pink-lighten-1' : ''"
          ...
          >
            ...
            <span :class="posting.voteType === VOTE_TYPE.HELPFUL ? 'font-weight-medium' : ''"
        ...
        <template v-else>
          ...
          >
            <v-btn
              :value="VOTE_TYPE.ONCE"
              color="pink"
              class="px-3 border border-e-0"
              @click="upvote(posting, VOTE_TYPE.ONCE)"
            >
              <template #prepend>
              ...
              <span
                class="selected"
                :class="posting.voteType === VOTE_TYPE.ONCE ? 'font-weight-medium' : ''"
                >{{ t('userPosting.understandOnce') }} {{ posting.once }}</span
              >
            </v-btn>

            <v-btn
              :value="VOTE_TYPE.TWICE"
              color="teal"
              class="px-3 border border-e-0"
            ...
            >
              ...
              <span
                class=""
                :class="posting.voteType === VOTE_TYPE.TWICE ? 'font-weight-medium' : ''"
                >{{ t('userPosting.understandTwice') }} {{ posting.twice }}</span
              >
            </v-btn>

            <v-btn
              :value="VOTE_TYPE.HELPFUL"
              color="brown"
              class="px-3 border"
            ...
            >
              ...
              <span
                class=""
                :class="posting.voteType === VOTE_TYPE.HELPFUL ? 'font-weight-medium' : ''"
