  ...
  <v-col cols="auto" class="pr-4 pt-0" style="width: 320px;">
    <v-card flat color="grey-lighten-5" rounded="xl" class="sticky-nav">
      <v-card-text class="pa-4">
        ...
        <!-- 用户统计简要信息 -->
        <div v-if="!loading && !error" class="mb-4 pa-3" style="background: rgba(25, 118, 210, 0.05); border-radius: 8px;">
        ...
        <v-list bg-color="transparent" class="pa-0">
          <v-list-item
            ...
            :class="[
              ...
              selectedTab === item.value ? 'nav-item-active' : 'nav-item-inactive'
            ]"
