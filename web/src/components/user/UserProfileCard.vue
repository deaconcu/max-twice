    ...
    <v-card-text class="pa-5">
      ...
      <div v-else class="text-center">
        ...
        <v-avatar :size="avatarSize" class="mb-3 profile-avatar">
          <v-img 
            :src="user.avatar || 'https://pica.zhimg.com/v2-b12a03a32cf776765897927720acb3bf_xll.jpg'"
            :alt="user.name"
          ></v-img>
        </v-avatar>
          ...
          <v-row class="ma-0" no-gutters>
            <v-col cols="3" class="text-center px-1">
              <div 
                ...
                @click="handleStatClick('followees')"
              >
            ...
            <v-col cols="3" class="text-center px-1">
              <div 
                class="stat-item clickable"
                @click="handleStatClick('subscriptions')"
              >
            ...
            <v-col cols="3" class="text-center px-1">
              <div 
                class="stat-item clickable"
                @click="handleStatClick('contents')"
              >
