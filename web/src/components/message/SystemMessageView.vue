<script setup>
  ...
  import { MESSAGE_TYPE, OBJECT_TYPE, VOTE_TYPE } from '@/constants/statusConstants'
  ...
  // 监听系统消息类型变化
  watch(systemMessageType, (newValue) => {
          ...
          >
            <div v-for="(message, index) in messageList" :key="message.id || index" class="mb-0">
              ...
              <div class="d-flex justify-start align-center">
                ...
                <div class="mt-2">
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.FOLLOW"
                    color="info"
                    variant="tonal"
                    size="small"
                    rounded="lg"
                  ...
                  >
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.UPVOTE"
                    color="success"
                    variant="tonal"
                    size="small"
                    rounded="lg"
                  ...
                  >
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.INVITE"
                    color="warning"
                    variant="tonal"
                    size="small"
                    rounded="lg"
                  ...
                  >
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.NODE_COMMENT"
                    color="primary"
                    variant="tonal"
                    size="small"
                    rounded="lg"
                  ...
                  >
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.POST_COMMENT"
                    color="primary"
                    variant="tonal"
                    size="small"
                    rounded="lg"
                  ...
                  >
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.REPLY_NODE_COMMENT"
                    color="primary"
                    variant="tonal"
                    size="small"
                    rounded="lg"
                  ...
                  >
                  <v-chip
                    v-if="message.type == MESSAGE_TYPE.REPLY_POSTING_COMMENT"
                    color="primary"
                    variant="tonal"
                    size="small"
                    rounded="lg"
